# Generated by Django 2.1.1 on 2018-11-06 03:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owner', to='PlayWithMe.Profile')),
                ('platforms', models.ManyToManyField(blank=True, to='PlayWithMe.Platform')),

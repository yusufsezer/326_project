# Generated by Django 2.1.1 on 2018-11-05 22:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(help_text="The user's username", max_length=20)),
                ('password', models.CharField(help_text="The user's password", max_length=20)),
                ('games', models.ManyToManyField(blank=True, to='PlayWithMe.Game')),
        ...
        migrations.AddField(
            model_name='session',
            name='users',
            field=models.ManyToManyField(to='PlayWithMe.User'),
        ),
        migrations.AddField(
            model_name='message',
            name='context',
        ...
        migrations.AddField(
            model_name='message',
            name='sender',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='PlayWithMe.User'),
        ),
        migrations.AddField(
            model_name='game',
            name='platforms',
